...
namespace MyGame.UISystem.WeaponTable
{
    public class WeaponTableUI : Singleton<WeaponTableUI>
    {
        ...
        public void OnChangeWeaponUI(int tableIndex, int bagIndex)
        {
            ...
            GameManager.Instance.player.playerWeapon.ChangeWeaponPun(tableType, bagIndex);
        }
        /// <summary>
        ///简略版武器的更换 
        /// </summary>
        public void ChangeWeaponUI(int tableIndex)
        {
            ...
            tableWeaponSlot[tableIndex].UnableSelected();
            GameManager.Instance.player.playerWeapon.ChangeWeaponPun(tableType, currentSelectBag);
        }
        /// <summary>
        /// 背包武器之间的交换
        /// </summary>
        public void ExchangeWeapon(int index1, int index2)
        {
            ...
            GameManager.Instance.player.playerWeapon.ExchangeWeaponPun(index1, index2);
